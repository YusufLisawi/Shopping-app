  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (Number(category) === -1)
        result = await axios("https://api.escuelajs.co/api/v1/products");
      else
        result = await axios(
      ...
      {loaded === false ? (
        <div className="grid place-content-center my-20">
          <div role="status">
            <svg
              aria-hidden="true"
              class="mr-2 w-20 h-20 text-gray-200 animate-spin dark:text-gray-600 fill-red-400"
              viewBox="0 0 100 101"
              fill="none"
        ...
        <div className="grid place-content-center duration-500">
